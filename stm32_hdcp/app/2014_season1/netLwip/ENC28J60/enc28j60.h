...
/* 用于定义enc28j60的片选引脚 */
#define RCC_APB2Periph_GPIO_ENC28J60_CS         RCC_APB2Periph_GPIOC
#define ENC28J60_CS_PORT                        GPIOA 
#define ENC28J60_CS_PIN                         GPIO_Pin_4 

#define ENC28J60_CS_ACTIVE()                    GPIO_ResetBits(ENC28J60_CS_PORT, ENC28J60_CS_PIN)
#define ENC28J60_CS_PASSIVE()                   GPIO_SetBits(ENC28J60_CS_PORT, ENC28J60_CS_PIN)
