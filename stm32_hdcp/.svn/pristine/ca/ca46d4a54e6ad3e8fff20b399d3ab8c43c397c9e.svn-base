...
;
; Note(s) : 1) PendSV_Handler is used to cause a context switch.  This is a recommended method for performing
...
;
;           3) On entry into PendSV_Handler handler:
...
;
;           4) Since PendSV_Handler is set to lowest priority in the system (by OSStartHighRdy() above), we
