...

{
...

    {
      ...
      RTC_WaitForLastTask();
        ...
        RTC_Set(2014,05,12,16,57,0);//默认时间
...
{
	u32 seccount=RTC_DateToSeconds(syear,smon,sday,hour,min,sec);
...
u8 RTC_Get(tm *timer)
{
	...
	timer->secondsCount = timecount;

	return RTC_SecondsToDate(timer,timecount);
