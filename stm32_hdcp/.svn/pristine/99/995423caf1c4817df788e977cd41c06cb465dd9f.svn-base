...
void Init_lwIP_UDP(void)
{
    ...
    netif_add(&_netif, &ipaddr, &netmask, &gw, NULL, &ethernetif_init, &udp_input);
...
void Init_lwIP(void)
{
	...
	nbns_init("gehang",&host_name_len,&_netif);
